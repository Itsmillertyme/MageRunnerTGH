...
public class Spell : ScriptableObject
{
    ...
    [Header("NO EDIT - Current Spell Attributes")]
    ...
    [Tooltip("Damage for each projectile")]
    [SerializeField] private int level1_Damage;
    ...
    [Tooltip("Damage for each projectile")]
    [SerializeField] private int level2_Damage;
    ...
    [Tooltip("Damage for each projectile")]
    [SerializeField] private int level3_Damage;
    ...
    public SpellName SpellIdentifier => spellName;
