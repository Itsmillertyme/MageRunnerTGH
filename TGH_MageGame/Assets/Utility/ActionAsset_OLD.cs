...
//     version 1.11.2
//     from Assets/Utility/ActionAsset_OLD.inputactions
//
...
public partial class @ActionAsset_OLD: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @ActionAsset_OLD()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ActionAsset_OLD"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@ActionAsset_OLD()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ActionAsset_OLD.Player.Disable() has not been called.");
    }
    ...
    {
        private @ActionAsset_OLD m_Wrapper;
        public PlayerActions(@ActionAsset_OLD wrapper) { m_Wrapper = wrapper; }
